...
var Pairs = [
    [103, 85, "Please save my friend!", "This precious friend can chat separately <!--break-->with three heads. Please help!"],
    [22, 112, "Please save my friend!", "Please save %s, <!--break-->my drilling buddy!"],
    [90, 394, "Please save my friend!", "Please save my best friend %s! <!--break-->We're both bivalves!"],
    [89, 342, "Please save my friend!", "Please rescue %s. <!--break-->I can't stand to see a sludge buddy hurt!"],
    [52, 325, "Please save my friend!", "Please rescue %s! <!--break-->We always play together!"],
    [129, 374, "Please save my friend!", "Help! %s isn't much now, but <!--break-->my friend is amazing after evolution!"],
    [13, 290, "Please save my friend!", "Help! I'm friends with %s <!--break-->because we both evolve fast! Please help!"],
    [293, 291, "Please save my friend!", "We identify with each other because we <!--break-->both evolved from Wurmple. Please help!"],
    [301, 16, "Please save my friend!", "%s and I are of the same height. <!--break-->We're lifelong friends! Please help!"],
    [37, 347, "Please save my friend!", "Please help %s--a good <!--break-->friend who shares my love of fire!"],
    [174, 173, "Please save my friend!", "Please rescue %s! <!--break-->We've been friends since we were eggs!"],
    [49, 294, "Please save my friend!", "Without %s, it's no fun playing <!--break-->with toxic powders! Someone, please help!"],
    [313, 57, "Please save my friend!", "%s is really noisy. <!--break-->But it's lonely without the racket... Sob..."],
    [286, 58, "Please save my friend!", "I can't play the biting game without my pal <!--break-->%s! Please help!"],
    [69, 238, "Please save my friend!", "Please help %s! Our cries are <!--break-->identical! We can tell each other anything!"],
    [86, 392, "Please save my friend!", "Someone save %s--my friend <!--break-->and rival at ball juggling!"],
    [97, 122, "Please save my friend!", "We promised each other to perform magic <!--break-->and hypnosis shows together. Please help!"],
    [98, 366, "Please save my friend!", "I want to help %s! <!--break-->We both have a thing for pincers!"],
    [143, 314, "Please save my friend!", "Please help %s! We're both lazy, <!--break-->so we're comfortable around each other!"],
    [127, 239, "Please save my friend!", "I lock horns with %s for fun. <!--break-->I terribly miss doing that..."],
    [240, 360, "Please save my friend!", "We promised to show each other how <!--break-->sharp our claws could be... Someone, help!"],
    [323, 175, "Please save my friend!", "Please help %s! <!--break-->My tiny and round best friend!"],
    [132, 185, "Please save my friend!", "Without %s around, there's no <!--break-->one to heckle! Please break my boredom!"],
    [241, 352, "Please save my friend!", "Please save %s. We're both alike <!--break-->in being kind of vacant and unpredictable!"],
    [79, 312, "Please save my friend!", "...Help... Please... <!--break-->Who was it?"],
    [164, 198, "Please save my friend!", "Without %s, there's no one for <!--break-->me to play with in the dark! Please help!"],
    [340, 182, "Please save my friend!", "I'm sad without %s's company. <!--break-->We showed flowers to each other..."],
    [250, 304, "Please save my friend!", "Please save %s. We've been in <!--break-->the delivery business for many years!"],
    [397, 38, "Please save my friend!", "Please save %s! We're both <!--break-->old-timers who are longtime friends!"],
    [187, 386, "Please save my friend!", "Help %s, please! <!--break-->We often took strolls on the wind!"],
    [200, 381, "Please save my friend!", "I feel lonely without %s to pull <!--break-->pranks and mess around with. Please help!"],
    [247, 398, "Please save my friend!", "Please rescue %s! The beach <!--break-->feels empty without my usual friend..."],
    [176, 267, "Please save my friend!", "We make each other happy--it's in our <!--break-->nature. Please save %s!"],
    [32, 29, "Please save my love!", "Please! Please rescue %s! <!--break-->We're madly in love!"],
    [33, 30, "Please save my love!", "Please rescue my precious %s! <!--break-->We're in love! Please help!"],
    [34, 31, "Please save my love!", "Please rescue %s! We <!--break-->promised our futures together! Please!"],
    [128, 266, "Please save my love!", "Please save my %s! Now I <!--break-->know what %s means to me..."],
    [338, 339, "Please save my love!", "Please save %s! <!--break-->We're no good if we're not together!"],
    [337, 336, "Please save my love!", "I can't live without %s! <!--break-->My heart is breaking! Please! Help!"],
    [360, 361, "Rescue my rival!", "Please rescue %s! We detest <!--break-->each other, but we need each other!"],
    [106, 107, "Rescue my rival!", "Please save %s. <!--break-->We owe each other a game!"],
    [362, 363, "Rescue my rival!", "%s can't leave without settling <!--break-->which one of us is better. Please help!"],
    [138, 140, "Rescue my rival!", "%s has been a rival since my <!--break-->ancestors' time. The rivalry can't end!"],
    [370, 372, "Rescue my rival!", "We've been rivals with %s for <!--break-->generations. It can't suddenly end like this!"],
    [172, 172, "Please help my brother!", "My little brother Pichu disappeared! <!--break-->I'm really worried! Someone, please help!"]
]
var Lovers = [
